...
def run_worker(
    ...
    comm_env: CollArgs = {
        ...
        "federated_server_address": f"192.168.137.227:{port}",
...
def run_federated_learning(with_ssl: bool, use_gpu: bool, test_path: str) -> None:
    ...
    if with_ssl:
        command = "openssl req -x509 -newkey rsa:2048 -days 7 -nodes -keyout {part}-key.pem -out {part}-cert.pem -subj /C=US/CN=192.168.137.227"  # pylint: disable=line-too-long
